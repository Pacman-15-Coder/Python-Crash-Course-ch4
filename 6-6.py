...
for f in friends:
    if f in favorite_languages:
        print(f"Hello, {f.title()} you have voted in the poll")
    if f not in favorite_languages:
        print(f"Hello, {f.title()} you have not yet voted in the poll")
